...
let exampleMenu = (createMenuItem('tacos', 8, 'Lunch'));
console.log(exampleMenu);
...
console.log(createMenuItem('Pho', 10, 'Dinner'));

console.log(createMenuItem('Steak', 35, 'Dinner'));
...
reviews.push({name: 'Edison', rating: 5, feedback: 'Great service!'});
...
reviews[7].feedback = 'My missing review is now here!';
