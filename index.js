...
console.log(createMenuItem('Steak', 30, 'Dinner'));
console.log(createMenuItem('Chorizo', 9, 'Breakfast'));
...
export const burger = {
  ...
  category: "Lunch", 
  discount: 
    function discountCode(position) {
      if (position === 'teacher') {
...
reviews.push({name: 'Edison', rating: 5, feedback: 'Service was amazing!'});
